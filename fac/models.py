...
class FacturaEnc(ClaseModelo2):
    ...
    class Meta:
        ...
        permissions = [ #permisos personalizados, usuario y contraseña para poder revertir 
...
class FacturaDet(ClaseModelo2):
    ...
    class Meta:
        ...
        permissions = [
            ('sup_caja_facturadet','Permisos de Supervisor de Caja Detalle') #PARA SUPERVISOR DE CAJA
        ]
